      ...
      <ul className="space-y-3">
        ...
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Lineages</span>
          </Link>
        </li>
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Magic</span>
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Natives</span>
          </Link>
        </li>
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Equipment</span>
          </Link>
        </li>
        <li>
          <Link
            href="/legendary-locations"
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Legendary Locations</span>
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Merchants</span>
          </Link>
        </li>
        <li>
          <Link
        ...
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Terrain Packs</span>
          </Link>
        </li>
        <li>
          <Link
            ...
            className="block rounded-lg border border-zinc-200 dark:border-zinc-800 px-5 py-4 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors"
          >
            <span className="text-lg font-medium">Clearing Types</span>
          </Link>
        </li>
        <li>
          <Link
